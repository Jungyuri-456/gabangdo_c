...
const fullPhone = computed(() => {
  return formattedNumber.value
    ? `${telPrefix.value}-${formattedNumber.value}`
    : "";
});
...
const summaryList = computed(() => [
  ...
  {
    l: "이용날짜 및 시간",
    v: `${formatKoreanDate(selectedDate.value)} ${selectedTime.value}`,
  },
]);
// 예약 제출 처리
      ...
      <div class="grid-container">
        ...
        <div class="summary-section">
          <div class="payment-section">
            <!-- 예약 요약 리스트 -->
            <p class="st_section-title">예약 정보</p>
            <div class="summary-list">
              <div class="summary-item" v-for="f in summaryList" :key="f.l">
                <strong>{{ f.l }}</strong>
                <div>{{ f.v }}</div>
              </div>
              ...
              <div class="summary-item">
                ...
                <div class="summary-value">
                  <div>{{ selectedStart }} → {{ selectedStop }}</div>
                  <div class="address">
                    <div v-if="customStartAddress" class="small-note">
                      출발 숙소명: {{ customStartAddress }}
                    </div>
                  </div>
                  <div v-if="customStopAddress" class="small-note">
                    도착 숙소명: {{ customStopAddress }}
                  </div>
                </div>
              </div>
            </div>
                ...
                <div v-if="showAllContent" class="toggle-content">
                  <div class="terms-box">
                    ...
                    <p>
                      ...
                      정보 입력 등으로 발생하는 불이익에 대해서는 당사가
                      책임지지 않습니다.
                    </p>
                    <p>
                      서비스 이용 시 기재한 연락처로 안내 메시지 또는 확인
                      전화를 드릴 수 있으므로, 정확한 정보를 입력해주시기
                      바랍니다.
                    </p>
                    <p>
                    ...
                    <p>
                      본 예약 서비스는 원활한 예약 처리 및 고객 응대를 위해
                      이름과 전화번호를 수집합니다.
                    </p>
                    <p>
              ...
              <transition name="fade">
                <div v-if="showTermsContent" class="toggle-content">
                  <div class="terms-box">
                    ...
                    <p>
                      제2조 (서비스의 제공) 회사는 이용자에게 사전예약, 일정
                      확인, 예약 정보 제공 등의 서비스를 제공합니다.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      최소한의 개인정보를 수집하며, 수집된 정보는 관련 법령에
                      따라 안전하게 관리됩니다. 개인정보 수집 및 이용에 대한
                      자세한 사항은 개인정보처리방침을 따릅니다.
                    </p>
                    <p>
                      제5조 (면책조항) 천재지변, 통신장애 등 회사의 책임 없는
                      사유로 서비스를 제공할 수 없는 경우, 회사는 이에 대한
                      책임을 지지 않습니다.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      해석되며, 서비스와 관련된 분쟁은 회사 본사 소재지를
                      관할하는 법원을 제1심 법원으로 합니다.
                    </p>
                  </div>
                </div>
              </transition>
...
//구분선
.line {
  border: 1px solid color.adjust($sub-color, $lightness: 40%);
  margin: 10px 0;
}
...
.payment-option {
  ...
  &:hover:not(.active) {
    background: color.adjust($blue-sky, $lightness: 40%);
  }
}
